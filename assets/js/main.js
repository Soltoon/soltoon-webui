...
var x = 685;
x += addButton(x, 290, "»»»", "مشاهده‌ی راند بعدی", function () {
    var x = Site.paused;
    Site.pause();
    if (x) {
...
x += addButton(x, 290, "»»", "مشاهده‌ی رخ‌داد بعدی", function () {
    var x = Site.paused;
    Site.pause();
    if (x) {
        Site.next();
...
x += addButton(x, 290, "««", "مشاهده‌ی رخ‌داد قبلی", function () {
    var x = Site.paused;
    Site.pause();
    if (x) {
        Site.prev();
...
x += addButton(x, 290, "«««", "مشاهده‌ی راند قبلی", function () {
    var x = Site.paused;
    Site.pause();
    if (x) {
...
x = 685;
x += addButton(x, 335, " ‌  ‌  ‌ + ‌  ‌  ‌ ", "افزایش سرعت بازی", function () {
...
x += addButton(x, 335, " ‌ ‌پـایــــــــــــــــان ‌ ‌", "کاهش سرعت بازی", function () {
    var x = Site.paused;
    Site.pause();
    if (x) {
...
x += addButton(x, 335, " ‌  ‌  ‌ - ‌  ‌  ‌ ", "کاهش سرعت بازی", function () {
